...
import style from "./FormularioMetaWildrift.module.css";
...
import { lanersChampionsMeta } from "@stores/dataWildrift";
import VisualizadorMetaWildrift from "./VisualizadorMetaWildrift";
import { fetchChampionsMeta } from "@stores/dataWildrift";
const FormularioMetaWildrift = () =>{
...
const saveChanges = async () => {
  try {
    const response = await fetch("https://api.guiadeparche.com/wildrift/saveMetaWildrift.php", {
      method: "POST",
      headers: {
    ...
    console.log("%cMetaWildrift updated from server", "background:blue;color:white");

  } catch (error) {
    console.error("Error saving or updating MetaWildrift:", error);
  }
};
...
return (
  <div>
    ...
    <VisualizadorMetaWildrift />
  </div>
)
}

export default FormularioMetaWildrift;