...
const InfografiaTop5 = () => {
  ...
  const [infografia, setInfografia] = useState({
    ...
    Top5Data: [
      { info: "Info 1", defaultColorInfo:"#000000", defaultInfoBackgroundColor:null, defaultTextInfo:"24px", defaultHorizontalInfo:"30px", defaultTextWeightInfo:400, value: "Value 1", defaultColorValue:"#ffffff", defaultValueBackgroundColor:null, defaultTextSize:"50px", defaultHorizontalSize:"90px", defaultTextWeightSize:800, image: null, top: "0px", left: "0px", width: "100%", height: "100%", widthFather:"100%", objectFit: "cover" },
      { info: "Info 2", defaultColorInfo:"#000000", defaultInfoBackgroundColor:null, defaultTextInfo:"24px", defaultHorizontalInfo:"30px", defaultTextWeightInfo:400, value: "Value 2", defaultColorValue:"#ffffff", defaultValueBackgroundColor:null, defaultTextSize:"50px", defaultHorizontalSize:"90px", defaultTextWeightSize:800, image: null, top: "0px", left: "0px", width: "100%", height: "100%", widthFather:"100%", objectFit: "cover" },
      { info: "Info 3", defaultColorInfo:"#000000", defaultInfoBackgroundColor:null, defaultTextInfo:"12px", defaultHorizontalInfo:"30px", defaultTextWeightInfo:400, value: "Value 3", defaultColorValue:"#ffffff", defaultValueBackgroundColor:null, defaultTextSize:"50px", defaultHorizontalSize:"90px", defaultTextWeightSize:800, image: null, top: "0px", left: "0px", width: "100%", height: "100%", widthFather:"100%", objectFit: "cover" },
      { info: "Info 4", defaultColorInfo:"#000000", defaultInfoBackgroundColor:null, defaultTextInfo:"12px", defaultHorizontalInfo:"30px", defaultTextWeightInfo:400, value: "Value 4", defaultColorValue:"#ffffff", defaultValueBackgroundColor:null, defaultTextSize:"50px", defaultHorizontalSize:"90px", defaultTextWeightSize:800, image: null, top: "0px", left: "0px", width: "100%", height: "100%", widthFather:"100%", objectFit: "cover" },
      { info: "Info 5", defaultColorInfo:"#000000", defaultInfoBackgroundColor:null, defaultTextInfo:"12px", defaultHorizontalInfo:"30px", defaultTextWeightInfo:400, value: "Value 5", defaultColorValue:"#ffffff", defaultValueBackgroundColor:null, defaultTextSize:"50px", defaultHorizontalSize:"90px", defaultTextWeightSize:800, image: null, top: "0px", left: "0px", width: "100%", height: "100%", widthFather:"100%", objectFit: "cover" },
    ],
    // Logos
