...
const Composicion = ({id, compo, admin=false, show=true, allwaysOpen=false, onToggle, isOpen})=>{
  ...
  return (
    ...
    <div className={[show ? style.containerInfoPrincipal : style.containerInfoPrincipalOculto , (open || isOpen) ? style.downBorder: "", compo?.isHide === "true" && admin ? "" : compo?.isHide === "true" ? style.isHide : "" ].join(" ")} onClick={()=>{onToggle()}}>
